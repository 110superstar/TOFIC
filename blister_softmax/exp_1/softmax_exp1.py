...
B1_180_training_set = query_Dataset(B1_180_set, 180, B1_180_train_index, 0)
...
B2_180_tune_set = query_Dataset(B2_180_set, 180, B2_180_tune_index, 0)
...
embedding_net_feature_layer = torch.nn.Sequential(*list(model.children())[:-1])
prototype_180_feature = get_prototype_feature(B1_180_prototype_loader, embedding_net_feature_layer)

# test stage
print('\ntest B1_180_test_loader')
accuracy_cosine, accuracy_euclidean, f1_cosine, f1_euclidean= test_epoch(B1_180_test_loader, embedding_net_feature_layer, prototype_180_feature)
...
print('processing prototype...')
embedding_net_feature_layer = torch.nn.Sequential(*list(model.children())[:-1])
prototype_180_feature = get_prototype_feature(B2_180_prototype_loader, embedding_net_feature_layer)

print('\ntest B2_180_test_loader')
accuracy_cosine, accuracy_euclidean, f1_cosine, f1_euclidean= test_epoch(B2_180_test_loader, embedding_net_feature_layer, prototype_180_feature)
print('Test set: F1 cosine: {:.4f}'.format(f1_cosine))
print('Test set: F1 euclidean: {:.4f}'.format(f1_euclidean))
print()
